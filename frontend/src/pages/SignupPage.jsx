...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-ink-950 flex items-center justify-center p-6"
      style={{
        backgroundImage: 'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(167,139,250,0.07) 0%, transparent 60%)'
      }}
    >
      <motion.div
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-white/40 mt-1.5">Join your team on FlowDesk</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <div className="mt-6 pt-6 border-t border-white/5 text-center">
            <p className="text-white/40 text-sm">
              ...
              <Link to="/login" className="text-acid hover:text-acid-dim transition-colors font-medium">
                Sign in
              </Link>
            </p>
          </div>
